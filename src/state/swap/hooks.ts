...
import { Currency, CurrencyAmount, ETHER, JSBI, Token, TokenAmount, Trade } from '@corgiswap/sdk'
import { ParsedQs } from 'qs'
import { useCallback, useEffect, useState } from 'react'
import { useDispatch, useSelector } from 'react-redux'
import { CORIS } from '../../constants'
...
export function useDerivedSwapInfo(): {
  ...
  const outputCurrency = useCurrency(outputCurrencyId || CORIS.address)
